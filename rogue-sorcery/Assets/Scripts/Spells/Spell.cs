...
namespace Rogue.Spell
{
    public class Spell : MonoBehaviour
    {
        ...
        public SpellDataSO Data { get; private set; }
        ...
        public GameObject SpellSpriteGameObject { get; private set; }
        ...
        public void SetData(SpellDataSO data)
        {
            Data = data;
        ...
        private void GetDependencies()
        {
            ...
            SpellSpriteGameObject = transform.Find("SpellSprite").gameObject;
        ...
        /// <summary>
        /// Invokes event to pass along information from the AnimationEventHandler to a non-spell class.
        /// </summary>
