...
public class PlayerInAirState : PlayerState
{
    ...
    public override void LogicUpdate()
    {
        ...
        if (player.InputHandler.AttackInputs[(int)CombatInputs.one] && player.PrimaryAttackState.CanTransitionToAttackState())
        {
            stateMachine.ChangeState(player.PrimaryAttackState);
        }
        else if (player.InputHandler.AttackInputs[(int)CombatInputs.two] && player.SecondaryAttackState.CanTransitionToAttackState())
        {
